...
def cal(ip):
    ...
    data = np.array([age_of_driver, vehicle_type, age_of_vehicle, engine_cc, day, weather, roadsc, light, gender, speedl])
...
def sms():
    ...
    try:
        ...
        resp =  sendSMS('035887072099aa09c88d72891655d4c5', '7038785672', 'TXTLCL', 'Severe acceident')
        print (resp)
